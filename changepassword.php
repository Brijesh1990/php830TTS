  ...
  <div class="container mt-5">
    ...
    <h2 class="text-success mt-5 line1">Change Your password! <i class="bi bi-person"></i></h2>
   
    <div class="row">
      <div class="col-md-4 card line">
      <div class="card-header" id="btn">Change Your password</div>
      ...
      <div class="col-md-7">
        ...
        <form method="post" name="frm" id="frm" onsubmit="return valid(this.value)">
          ...
          <div class="form-group mt-2">
            <input type="submit" name="chang" class="btn btn-lg" id="btn"
              value="Submit">
