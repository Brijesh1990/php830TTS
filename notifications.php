  ...
  <div class="container mt-5">
    ...
    <div class="row">
      ...
      <img src="<?php echo $baseurl;?>images/not.gif" class="img-fluid" style="width:45%">
        <a href="#" class="btn btn-lg" id="btn" style="width:350px; padding:15px;margin-left:0%; margin-top:10%">Your notifications  <span class="badge badge-dark bg-dark badge-lg">0</span></a>  
