...
<div class="col-md-10 mx-auto col-xs-12 col-md-offset-1">
...
<div class="card-body">
<h3 style="font-size:30px; letter-spacing:2px; color:green">Thanks for Payment with Sharddha Ecommerce </h3> 
...
?>	
<center>
<a href="<?php echo $mainurl;?>PrintInvoice"><button type="button" class="btn btn-lg btn-danger" style="margin-left:1%" id="btn" onclick="pr()">Print Invoice <span class="fa fa-file-o"></span></button></a>
</center>
